<div>
        ...
        <div class="p-6">
            ...
            @else
                <div class="flex items-center p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                    ...
                    <div>
                        <span class="font-medium">AVISO!</span> No hay opciones disponibles, cuando agregues una opción
                        se mostrará aquí.
                    </div>
                </div>
            @endif
    ...
    <x-dialog-modal wire:model="variantEdit.open">
        ...
        <x-slot name="footer">
            <x-button wire:click="updateVariant">
                Guardar
            </x-button>

            <x-danger-button class="ml-4" x-on:click="show = false">
                Cancelar
            </x-danger-button>
        </x-slot>
