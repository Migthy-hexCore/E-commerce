        ...
        <x-container class="px-4 py-4">
            <div class="flex justify-between items-center space-x-8">
                ...
                <div class="flex-1 hidden md:block">
                    <x-input class="w-full" placeholder="Buscar por producto o marca" />
                </div>
            ...
            <div class="mt-4 md:hidden">
                <div class="relative w-full">
                    <x-input class="w-full pl-10" placeholder="Buscar por producto o marca" />
                ...
                <div class="h-[calc(100vh-52px)] overflow-auto px-6 py-8 bg-white">
                    ...
                    <ul class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                        @foreach ($this->categories as $category)
                            <li>
                                <a class="text-indigo-700 font-semibold" href="">
                                    {{ $category->name }}
                                </a>
                                ...
                                <ul class="mt-4 space-y-2">
                                    @foreach ($category->subcategories as $subcategory)
                                        <li>
                                            <a href="" class="text-sm text-gray-700 hover:text-indigo-700">
                                                {{ $subcategory->name }}
                                            </a>
                                        </li>
                                    @endforeach
